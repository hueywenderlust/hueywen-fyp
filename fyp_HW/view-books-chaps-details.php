    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <div class="row pad-botm">
                <div class="col-md-12">
                    <h3 class="header-line"> My Research Books / Books' Chapters List</h3>
                </div>
                <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" style="padding: 20px;" >
                             Research Books / Books' Chapters List

                            <a href="books-chaps.php">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tr>
                                        ...
                                        <th>Chapter Title</th>
                                        <th>Book Title</th>
                                        <th>Book Editor's Name</th>
                                        <th>Publisher</th>
                                        <th>ISBN No</th>
                                        <th>Page Start</th>
                                        <th>Page End</th>
                                        <th>Other Info / URL</th>
                                        <th>Action</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    ...
                                    $sql = "SELECT * from `books-chaps` where user_ID = $user_ID order by id desc;";
                                    ...
                                    if($query->rowCount() > 0) {
                                        ...
                                        foreach($results as $result) {
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td class="center"><?php echo htmlentities($result->chapTitle);?></td>
                                                <td class="center"><?php echo htmlentities($result->bookTitle);?></td>
                                                <td class="center"><?php echo htmlentities($result->bookEditor);?></td>
                                                <td class="center"><?php echo htmlentities($result->publisher);?></td>
                                                <td class="center"><?php echo htmlentities($result->isbn_no);?></td>
                                                <td class="center"><?php echo htmlentities($result->pageStart);?></td>
                                                <td class="center"><?php echo htmlentities($result->pageEnd);?></td>
                                                <td class="center"><?php echo htmlentities($result->otherInfo_url);?></td>

                                                <td class="center">
                                                    <form action="manage-bookChaps.php"  method="get">
