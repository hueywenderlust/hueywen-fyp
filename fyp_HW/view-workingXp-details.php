    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <div class="row pad-botm">
                <div class="col-md-12">
                    <h3 class="header-line">My Work History</h3>
                </div>
                <div class="row">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    $sql = "SELECT * from workingXp where user_ID = $user_ID order by id desc;";
                                    ...
                                    if($query->rowCount() > 0) {
                                        ...
                                        foreach($results as $result) {
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td class="center"><?php echo htmlentities($result->jobPosition);?></td>
                                                <td class="center"><?php echo htmlentities($result->company);?></td>
                                                <td class="center"><?php echo htmlentities($result->startYear);?></td>
                                                <td class="center"><?php echo htmlentities($result->endYear);?></td>
                                                <td class="center"><?php echo htmlentities($result->description);?></td>

                                                <td class="center">
                                                    <form action="manage-workingXp.php"  method="get">
