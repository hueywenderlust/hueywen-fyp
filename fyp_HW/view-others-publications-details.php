    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <div class="row pad-botm">
                <div class="col-md-12">
                    <h3 class="header-line"> My Others Publications</h3>
                </div>
                <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" style="padding: 20px;" >
                            Others Publication List

                            <a href="others-publications.php">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    $sql = "SELECT * from other_publications where user_ID = $user_ID order by id desc;";
                                    ...
                                    if($query->rowCount() > 0) {
                                        ...
                                        foreach($results as $result) {
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td class="center">
                                                    <form action="manage-otherPublication.php"  method="get">
