    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <div class="row pad-botm">
                <div class="col-md-12">
                    <h3 class="header-line"> My Research Areas</h3>
                </div>
                <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" style="padding: 20px;" >
                            ...
                            <a href="researchArea.php">
                                <button type="submit"  class="btn btn-info btn- update" style="float: right;">
                                    <i class="fa fa-plus"></i> add / <i class="far fa-edit"></i> update
                                </button>
                            </a>
...
<!--                                        <th>Action</th>-->
                                    ...
                                    $sql = "SELECT * FROM researcharea_details where user_ID = $user_ID order by category";
