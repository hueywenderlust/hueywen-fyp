        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                ...
                <div class="row pad-botm">
                    <div class="col-md-12">
                        <h3 class="header-line">Awards Details</h3>
                    </div>
                    <div class="row">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" style="padding: 20px;" >Awards List</div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tr>
                                            <th>#</th>
                                            <th>Staff ID</th>
                                            <th>Name of Award conferred / Committee position appointed</th>
                                        ...
                                        $sql = "SELECT * from awards order by user_ID;";
                                        ...
                                        if($query->rowCount() > 0) {
                                            ...
                                            foreach($results as $result) {
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td class="center"><?php echo htmlentities($result->awardName);?></td>
                                                    <td class="center"><?php echo htmlentities($result->conferringBody);?></td>
                                                    <td class="center"><?php echo htmlentities($result->awardType);?></td>
                                                    <td class="center"><?php echo htmlentities($result->awardDetails);?></td>
                                                </tr>
                                                <?php $cnt=$cnt+1;}} ?>
                                        </tbody>
                                    </table>
