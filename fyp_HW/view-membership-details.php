    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <div class="row pad-botm">
                <div class="col-md-12">
                    <h3 class="header-line"> My Membership Details</h3>
                </div>
                <div class="row">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tr>
                                        <th>#</th>
                                        <th>Name of Association / Body / Institution / NGOs</th>
                                    ...
                                    $sql = "SELECT * from membership where user_ID = $user_ID order by id desc;";
                                    ...
                                    if($query->rowCount() > 0) {
                                        ...
                                        foreach($results as $result) {
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td class="center"><?php echo htmlentities($result->memberType);?></td>
                                                ...
                                                <td class="center"><?php echo htmlentities($result->appointmentStart);?></td>
                                                <td class="center"><?php echo htmlentities($result->appointmentEnd);?></td>


                                                <td class="center">
                                                    <form action="manage-membership.php"  method="get">
