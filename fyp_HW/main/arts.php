...
$description = "The School of Arts offers students a superior learning experience through excellent teaching and project-based 
                learning. We are large enough to provide the facilities, equipment and expertise that you need to launch your 
                future, while also being small enough to focus on you as an individual.
                <br><br>
                Students in our programmes engage in practical and theoretical studies and activities throughout the period of 
                instruction. Students majoring in different disciplines within the School will also have opportunities to work 
                together, an experience that is akin to real-world artistic collaborations.
                <br><br>
                We are preparing a new generation of students and researchers in the domain of creative digital media (CDM), 
                merging core attributes of the arts, sciences, humanities, media and technology";


$department_list = array();

array_push($department_list,"Department of Art and Design");
array_push($department_list,"Department of Communication and Liberal Arts");
array_push($department_list,"Department of Performance and Media");
