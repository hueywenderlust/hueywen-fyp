    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <div class="row pad-botm">
                <div class="col-md-12">
                    <h3 class="header-line"> My Research Activities</h3>
                </div>
                <div class="row">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tr>
                                        <th>#</th>
                                        <th>Title of Research / Programme</th>
                                        <th>Country</th>
                                        <th>Collaborator's Name and Institution</th>
                                        <th>Position</th>
                                        <th>Name of MoA / LoA</th>
                                        <th>Funding Body</th>
                                    ...
                                    $sql = "SELECT * from research_activities where user_ID = $user_ID order by id desc;";
                                    ...
                                    if($query->rowCount() > 0) {
                                        ...
                                        foreach($results as $result) {
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td class="center"><?php echo htmlentities($result->researchTitle);?></td>
                                                <td class="center"><?php echo htmlentities($result->country);?></td>
                                                <td class="center"><?php echo htmlentities($result->collabName);?></td>
                                                <td class="center"><?php echo htmlentities($result->position);?></td>
                                                <td class="center"><?php echo htmlentities($result->moa_loa);?></td>
                                                <td class="center"><?php echo htmlentities($result->fundingBody);?></td>
                                                <td class="center"><?php echo htmlentities($result->fundingAmount);?></td>
                                                <td class="center"><?php echo htmlentities($result->startDate);?></td>
                                                <td class="center"><?php echo htmlentities($result->endDate);?></td>

                                                <td class="center">
                                                    <form action="manage-researchActivities.php"  method="get">
