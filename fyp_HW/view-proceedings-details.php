    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <div class="row pad-botm">
                <div class="col-md-12">
                    <h3 class="header-line">My Proceedings</h3>
                </div>
                <div class="row">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    $sql = "SELECT * from proceedings where user_ID = $user_ID order by id desc;";
                                    ...
                                    if($query->rowCount() > 0) {
                                        ...
                                        foreach($results as $result) {
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td class="center"><?php echo htmlentities($result->paperTitle);?></td>
                                                <td class="center"><?php echo htmlentities($result->proceedingsTitle);?></td>
                                                <td class="center"><?php echo htmlentities($result->issueVol);?></td>
                                                <td class="center"><?php echo htmlentities($result->pageNo);?></td>
                                                <td class="center"><?php echo htmlentities($result->articleID);?></td>
                                                <td class="center"><?php echo htmlentities($result->url);?></td>
                                                <td class="center"><?php echo htmlentities($result->issn_ibsn);?></td>

                                                <td class="center">
                                                    <form action="manage-proceeding.php"  method="get">
