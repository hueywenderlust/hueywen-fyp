    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <div class="row pad-botm">
                <div class="col-md-12">
                    <h3 class="header-line">My Other IPs</h3>
                </div>
                <div class="row">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tr>
                                        <th>#</th>
                                        <th>Title of creation / Name of IP</th>
                                        <th>Type</th>
                                        <th>Creator's Name and Affiliation</th>
                                        <th>Date Registered</th>
                                        <th>Document Ref No. / ISBN No. </th>
                                        <th>Action</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    ...
                                    $sql = "SELECT * from ips where user_ID = $user_ID order by dateReg desc;";
                                    ...
                                    if($query->rowCount() > 0) {
                                        ...
                                        foreach($results as $result) {
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td class="center"><?php echo htmlentities($result->nameIP);?></td>
                                                <td class="center"><?php echo htmlentities($result->IPtype);?></td>
                                                <td class="center"><?php echo htmlentities($result->creators);?></td>
                                                <td class="center"><?php echo htmlentities($result->dateReg);?></td>
                                                <td class="center"><?php echo htmlentities($result->refNo);?></td>


                                                <td class="center">
                                                    <form action="manage-ips.php"  method="get">
