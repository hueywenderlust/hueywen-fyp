    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <div class="row pad-botm">
                <div class="col-md-12">
                    <h3 class="header-line">My Education Qualification</h3>
                </div>
                <div class="row">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    $sql = "SELECT * from eduDetails where user_ID = $user_ID order by year;";
                                    ...
                                    if($query->rowCount() > 0) {
                                        ...
                                        foreach($results as $result) {
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td class="center"><?php echo htmlentities($result->eduLevel);?></td>
                                                <td class="center"><?php echo htmlentities($result->degreeName);?></td>
                                                <td class="center"><?php echo htmlentities($result->memberRegNo);?></td>
                                                <td class="center"><?php echo htmlentities($result->year);?></td>
                                                <td class="center"><?php echo htmlentities($result->institute);?></td>
                                                <td class="center"><?php echo htmlentities($result->country);?></td>


                                                <td class="center">
                                                    <form action="manage-eduDetails.php"  method="get">
