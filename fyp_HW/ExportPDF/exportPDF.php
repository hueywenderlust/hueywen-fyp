...
//             $fullName = ucfirst($output["fullName"]);
//             $staffNo = ucfirst($output["staffNo"]);
//             $nationality = ucfirst($output["nationality"]);
//             $dob = ucfirst($output["dob"]);
//             $position = ucfirst($output["position"]);
//             $faculty = ucfirst($output["faculty"]);
//             $department = ucfirst($output["department"]);
//             $startDate = ucfirst($output["startDate"]);

//             $A = "Full Name: ".$fullName;
//             $B = "Staff Number: ".$staffNo;
//             $C = "Nationality: ".$nationality;
//             $D = "Date of Birth: ".$dob;
//             $E = "Position: ".$position;
//             $F = "School: ".$faculty;
//             $G = "Department: ".$department;
//             $H = "Start Date of Appointment at Sunway: ".$startDate;
